...
from instagrapi.instagrapi.extractors import extract_user_gql, extract_user_short, extract_user_v1
from instagrapi.instagrapi.types import Relationship, RelationshipShort, User, UserShort
